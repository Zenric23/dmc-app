...
export default function PageContent({
  ...
  // Custom Inbound page states and variables scope

  const inboundPage = data_access.find(
    (d) => d?.domain === "intake_items" && d?.source_type === "domain",
  );
  ...
  const {
    ...
    domain: inboundPage?.domain,
    system: inboundPage?.system,
  });
